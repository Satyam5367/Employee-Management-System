...
namespace EmployeeManagementSystem.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Seed Employees
            migrationBuilder.InsertData(table: "Employees", columns: new[] {
                "Id","FirstName","LastName","Email","Phone","Department","JobTitle",
                "DateOfJoining","Salary","IsActive","Address","CreatedAt","UpdatedAt"
            }, values: new object[,] {
                { 1,"Alice","Johnson","alice.johnson@company.com","9876543210","Engineering","Senior Software Engineer",
                  new DateTime(2021,3,15),95000m,true,"123 Tech Park, Bangalore",new DateTime(2021,3,15),new DateTime(2021,3,15)},
                { 2,"Bob","Smith","bob.smith@company.com","9876543211","Human Resources","HR Manager",
                  new DateTime(2020,6,1),75000m,true,"456 Corporate Blvd, Mumbai",new DateTime(2020,6,1),new DateTime(2020,6,1)},
                { 3,"Carol","Davis","carol.davis@company.com","9876543212","Finance","Financial Analyst",
                  new DateTime(2022,1,10),70000m,true,"789 Finance St, Delhi",new DateTime(2022,1,10),new DateTime(2022,1,10)},
                { 4,"David","Wilson","david.wilson@company.com","9876543213","Engineering","Junior Developer",
                  new DateTime(2023,8,20),45000m,false,"321 Startup Lane, Hyderabad",new DateTime(2023,8,20),new DateTime(2023,8,20)},
                { 5,"Eva","Martinez","eva.martinez@company.com","9876543214","Marketing","Marketing Lead",
                  new DateTime(2021,11,5),68000m,true,"654 Market Ave, Chennai",new DateTime(2021,11,5),new DateTime(2021,11,5)}
            });
